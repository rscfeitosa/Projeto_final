...
SECRET_KEY = 'django-insecure-f9nhz$v%jj3+=!tav8^36puy$v1_f2&8$cemm^+m7e39wti&m%'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static')#apontamento para a pasta de arquivos de imagem 
STATICFILES_DIRS = [
